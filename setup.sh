...
# Kullanim: bash -c "$(curl -sL https://raw.githubusercontent.com/seghobs/kontrolv9-vip-premium/main/setup.sh)"
...
git clone https://github.com/seghobs/kontrolv9-vip-premium.git mysite
