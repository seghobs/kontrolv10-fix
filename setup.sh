...
# Kullanim: bash -c "$(curl -sL https://raw.githubusercontent.com/seghobs/kontrolv10-fix/main/setup.sh)"
...
git clone https://github.com/seghobs/kontrolv10-fix.git mysite
